...
HD_PWD='/home/narayan/Documents/FPGA/Exercise_4/Exercise_4.runs/base_zynq_led_blink_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_zynq_led_blink_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_zynq_led_blink_0_1.tcl
