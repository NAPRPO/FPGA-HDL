...
-- Date        : Wed Apr 17 09:25:17 2019
-- Host        : narayan-Lenovo-B590 running 64-bit Ubuntu 18.04.2 LTS
-- Command     : write_vhdl -force -mode funcsim
--               /home/narayan/Documents/FPGA/Exercise_4/Exercise_4.srcs/sources_1/bd/base_zynq/ip/base_zynq_led_blink_0_1/base_zynq_led_blink_0_1_sim_netlist.vhdl
...
entity base_zynq_led_blink_0_1_clk_divider is
  port (
  ...
  attribute ORIG_REF_NAME of base_zynq_led_blink_0_1_clk_divider : entity is "clk_divider";
end base_zynq_led_blink_0_1_clk_divider;

architecture STRUCTURE of base_zynq_led_blink_0_1_clk_divider is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity base_zynq_led_blink_0_1_counter_1 is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of base_zynq_led_blink_0_1_counter_1 : entity is "counter_1";
end base_zynq_led_blink_0_1_counter_1;

architecture STRUCTURE of base_zynq_led_blink_0_1_counter_1 is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity base_zynq_led_blink_0_1_counter_2 is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of base_zynq_led_blink_0_1_counter_2 : entity is "counter_2";
end base_zynq_led_blink_0_1_counter_2;

architecture STRUCTURE of base_zynq_led_blink_0_1_counter_2 is
  signal counter : STD_LOGIC_VECTOR ( 3 downto 0 );
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity base_zynq_led_blink_0_1_led_blink is
  port (
    rst : in STD_LOGIC;
    clk : in STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of base_zynq_led_blink_0_1_led_blink : entity is "led_blink";
end base_zynq_led_blink_0_1_led_blink;

architecture STRUCTURE of base_zynq_led_blink_0_1_led_blink is
...
begin
CLK_DIV: entity work.base_zynq_led_blink_0_1_clk_divider
     port map (
      clk => clk,
...
CNT_1: entity work.base_zynq_led_blink_0_1_counter_1
     port map (
      CLK => clk_counter1,
      Q(7) => CNT_1_n_0,
      Q(6) => CNT_1_n_1,
...
CNT_2: entity work.base_zynq_led_blink_0_1_counter_2
     port map (
      CLK => clk_counter2,
      Q(7) => CNT_1_n_0,
      Q(6) => CNT_1_n_1,
...
entity base_zynq_led_blink_0_1 is
  ...
  attribute NotValidForBitStream of base_zynq_led_blink_0_1 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of base_zynq_led_blink_0_1 : entity is "base_zynq_led_blink_0_1,led_blink,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of base_zynq_led_blink_0_1 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of base_zynq_led_blink_0_1 : entity is "package_project";
  attribute x_core_info : string;
  attribute x_core_info of base_zynq_led_blink_0_1 : entity is "led_blink,Vivado 2018.3";
end base_zynq_led_blink_0_1;

architecture STRUCTURE of base_zynq_led_blink_0_1 is
...
begin
U0: entity work.base_zynq_led_blink_0_1_led_blink
     port map (
      clk => clk,
      led(7 downto 0) => led(7 downto 0),
      rst => rst,
